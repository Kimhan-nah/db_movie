                        ...
                        <div style={{ padding: "10px" }}>
                            ...
                            <div style={{ overflow: "auto", height: "470px" }}>
                                {movieNames.map((movieName) => (
                                    <Button
                                        key={movieName.M_CODE}
                                        id={`${movieName.M_CODE}/${movieName.M_AGE_LIMIT}`}
                                        color="secondary"
                                        style={{ display: "block" }}
                                        onClick={handleMovie}
                                    >
                        ...
                        <div style={{ padding: "10px" }}>
                            {totalTime.map((tt) => (
                                <Button
                                    ...
                                    onClick={handleTime}
                                >
                                    {tt.MT_SCREEN_SPACE} {tt.MT_START_TIME} (
                                    {tt.MT_AVAIL_SEAT} / {tt.MT_TOTAL_SEAT})
                                </Button>
                            ))}
                        </div>
                    </Grid>
                    ...
                    <Grid container>
                        ...
                        <Grid item xs={3}>
                            ...
                            >
                                ...
                                <div>
                                    일시 : {date.name} {time.name.split(" ")[2]}
                                </div>
                                <div>
                                    상영관 : {time.name.split(" ")[0]}{" "}
                                    {time.name.split(" ")[1]}
                                </div>
                            </div>
                        </Grid>
                        <Grid item xs={7} style={{ color: "#808080" }}>
                            <div
                                style={{ paddingTop: "10px", marginLeft: "5%" }}
                            >
                                <ArrowForwardIosIcon />
